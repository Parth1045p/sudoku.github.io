...
function startGame() {
  ...
  // set lives to 3 and enables selecting numbers and tiles
  lives = 3;
  disableSelect = false;
...
function startTimer() {
  ...
  timer = setInterval(function () {
    timeRemaining--;
    // If no time reaming end the game
    if (timeRemaining == 0) endGame();
    id("timer").textContent = timeConversion(timeRemaining);
  }, 1000);
}
// Converts second into string of MM:SS formst
      ...
      tile.addEventListener("click", function () {
        ...
        if (!disableSelect) {
          ...
          if (tile.classList.contains("selected")) {
            ...
            // Add selector and update variable
...
function updateMove() {
  ...
  if (selectedTile && selectedNum) {
    ...
    if (checkedCorrect(selectedTile)) {
      // Deselect the tiles
